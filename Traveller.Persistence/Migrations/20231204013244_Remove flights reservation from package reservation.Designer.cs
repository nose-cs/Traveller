...
namespace Traveller.Persistence.Migrations
{
    ...
    [Migration("20231204013244_Remove flights reservation from package reservation")]
    partial class Removeflightsreservationfrompackagereservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Traveller.Domain.Models.PackageTour", b =>
                {
                    ...
                    b.HasKey("TourId", "PackageId")
                        .HasName("PK_PackageTour");

                    b.HasIndex("PackageId");

                    b.ToTable("PackageTours");
                });
            ...
            modelBuilder.Entity("Traveller.Domain.Models.PackageTour", b =>
                {
                    ...
                    b.HasOne("Traveller.Domain.Models.Tour", "Tour")
                        .WithMany("Packages")
