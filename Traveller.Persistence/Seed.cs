...
public static class ModelBuilderExtensions
{
    ...
    {
        modelBuilder.Entity<Agency>().HasData(GenerateAgencies());
        modelBuilder.Entity<Hotel>().HasData(GenerateHotels());
        modelBuilder.Entity<HotelOffer>().HasData(GenerateHotelOffers());
    }
